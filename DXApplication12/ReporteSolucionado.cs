...
namespace ReportesApp
{
    ...
    public partial class ReporteSolucionado
    {
        public int idReporteSolucionado { get; set; }
        public Nullable<int> idEntorno { get; set; }
        public int idEquipo { get; set; }
        public int idProblemaPosible { get; set; }
        public int idAdministradorDefecto { get; set; }
        public string numero { get; set; }
        public System.DateTime fecha_hora { get; set; }
        public System.DateTime fecha_horaFin { get; set; }
