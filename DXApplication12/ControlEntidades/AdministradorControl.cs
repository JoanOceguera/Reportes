...
namespace ReportesApp.ControlEntidades
{
    class AdministradorControl : Controlador
    {
        ...
        /// </summary>
        public Administrador Crear(String nombreAdministrador, byte[] foto, bool tecnico)
        {
            Administrador administ = new Administrador() { nombre = nombreAdministrador, foto = foto, desuso = 0, tecnico = tecnico };
            return administ;
        }

        public Administrador Crear(String nombreAdministrador, byte[] foto, int desuso, bool tecnico)
        {
            Administrador administ = new Administrador() { nombre = nombreAdministrador, foto = foto, desuso = desuso, tecnico = tecnico };
            return administ;
        }
