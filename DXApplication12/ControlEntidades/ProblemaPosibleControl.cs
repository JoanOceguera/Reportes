...
namespace ReportesApp.ControlEntidades
{
    class ProblemaPosibleControl : Controlador
    {
        ...
        /// </summary>
        public ProblemaPosible Crear(String problemaInfo, bool comsumible)
        {            
            ProblemaPosible problemPos = new ProblemaPosible() { problemaInfo = problemaInfo, desuso = 0, consumible = comsumible};
            return problemPos;    
        }
